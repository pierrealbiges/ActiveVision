...
\thesistitle{Computational modelling of visual object localization in the magnocellular pathway} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Emmanuel \textsc{Daucé}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\keywords{Vision, Biomimétisme, Machine Learning} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\group{\href{http://ins.univ-amu.fr/}{Institut de Neurosciences des Systèmes}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\emph{Superviseur:} \\
\href{http://emmanuel.dauce.free.fr/}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]

\vfill
\large \textit{Une thèse présentée à\\ \textsc{Ecole Doctorale des Sciences de la Vie et de la Santé}\\en vue de l'obtention du diplôme de\\ \textsc{\degreename}}\\[0.3cm] % University requirement text
\textit{et réalisée au sein de}\\[0.4cm]
\groupname\\[2cm] % Research group name and department name
\small \textit{Durant la période : 04/12/2017 - 02/03/2018}\\[4cm] % Date
...
\include{Chapters/Materiel_methode} 
