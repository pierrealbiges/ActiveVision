...
\subject{Neurosciences computationnelles} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
...
\large \textit{Une thèse soumise en conformité avec les exigences\\ afin d'obtenir le diplôme de \degreename}\\[0.3cm] % University requirement text
