...
La variabilité de l'acuité visuelle et les saccades oculaires sont deux caractéristiques primordiales de notre système visuel, se complétant pour l'aider à réaliser des descriptions précises, rapides et robustes de l'environnement visuel d'un individu.
Dans ce travail exploratoire, nous tentons de simuler ces fonctionnalités pour créer un modèle neuro-mimétique d'exploration visuelle, capable de façon autonome de repérer une cible dans son environnement. L'image courante de la scène visuelle est observé au travers d'une grille de type rétinien suivant une loi dite log-polaire et simulant la variabilité de l'acuité visuelle. L'utilisation de cette grille permet une diminution de 100 des resources de calcul nécessaires. Notre objectif est alors de réaliser une ou plusieurs saccade(s) pour la placer au plus près de sa fovéa.
Pour cela nous utilisons un ensemble de méthodes issues de l'apprentissage automatisé pour obtenir progressivement une amélioration de la prédiction de la position de la cible. Le développement du modèle en est à ses premières étapes et nous pensons que notre travail peut être considéré comme une preuve de concept encourageant de futurs développements pour tenter de construire un modèle rapide et robuste pouvant aider à l'avancée de la vision artificielle et de notre compréhension du fonctionnement neurophysiologique du système visuel.
\end{abstract}
