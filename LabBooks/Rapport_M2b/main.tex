...
La variabilité de l'acuité visuelle et les saccades oculaires sont deux caractéristiques primordiales de notre système visuel, se complétant pour l'aider à réaliser des décriptions précises, rapides et robustes de l'environnement visuel d'un individu.
Dans ce travail exploratoire, nous tentons de simuler ces fonctionnalités pour créer un modèle neuromimétique d'exploration visuelle, capable de façon autonome de repérer une cible dans son environnement, observé au travers d'un filtre LogPolaire simulant la variabilité de l'acuité visuelle, et de réaliser une ou plusieurs saccade(s) pour la placer au plus près de sa fovéa.
Pour cela nous utilisons un ensemble de méthodes issues de l'apprentissage automatisé pour obtenir des performances élevées lors de tentatives de prédiction de position de cible, tout en conservant un modèle simple et peu couteux en puissance de calcul.
Malgré que le développement du modèle en soit à ses premières étapes, nous pensons que notre travail peut être considéré comme une preuve de concept encourageant de futurs développements pour tenter de construire un modèle rapide et robuste pouvant aider à l'avancée de la vision artificielle et de la compréhension neurophysiologique du fonctionnement du système visuel.
\end{abstract}
